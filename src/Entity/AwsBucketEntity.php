 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/aws_bucket_fs/aws_buckets/{aws_bucket_entity}",
 *     "add-form" = "/admin/aws_bucket_fs/aws_buckets/add",
 *     "edit-form" = "/admin/aws_bucket_fs/aws_buckets/{aws_bucket_entity}/edit",
 *     "delete-form" = "/admin/aws_bucket_fs/aws_buckets/{aws_bucket_entity}/delete",
 *     "version-history" = "/admin/aws_bucket_fs/aws_buckets/{aws_bucket_entity}/revisions",
 *     "revision" = "/admin/aws_bucket_fs/aws_buckets/{aws_bucket_entity}/revisions/{aws_bucket_entity_revision}/view",
 *     "revision_revert" = "/admin/aws_bucket_fs/aws_buckets/{aws_bucket_entity}/revisions/{aws_bucket_entity_revision}/revert",
 *     "revision_delete" = "/admin/aws_bucket_fs/aws_buckets/{aws_bucket_entity}/revisions/{aws_bucket_entity_revision}/delete",
 *     "collection" = "/admin/aws_bucket_fs/aws_buckets",
 *   },
