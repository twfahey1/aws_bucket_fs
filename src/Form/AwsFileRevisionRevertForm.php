...
/**
 * Provides a form for reverting a Aws file revision.
 *
 * @ingroup aws_bucket_fs
 */
class AwsFileRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'aws_file_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Aws file: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    $this->messenger()->addMessage(t('Aws file %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\aws_bucket_fs\Entity\AwsFileInterface $revision
   ...
   */
  protected function prepareRevertedRevision(AwsFileInterface $revision, FormStateInterface $form_state) {
